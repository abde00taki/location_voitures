...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 26 juil. 2025 à 19:40
...
(2, 'BMW', '67890-B', 'X5', '', 700.00, 'diesel', '1752939657848.jpeg', NULL, NULL),
...
--
ALTER TABLE `notifications`
  MODIFY `id_notification` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `rent`
--
ALTER TABLE `rent`
  MODIFY `id_rent` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
