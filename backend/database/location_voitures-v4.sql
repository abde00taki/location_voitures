...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 22 juil. 2025 à 15:08
...
(3, '', '', '', '', 0.00, '', '1752939912010.jpg', NULL, NULL),
...
(2, '2025-07-22', '2025-07-24', 3, 9, 'accepted'),
(3, '2025-07-22', '2025-07-25', 2, 10, ''),
(4, '2025-07-24', '2025-07-29', 2, 9, 'pending'),
...
(10, 'jamal', 'jalil', 'jamal@gmail.com', '$2b$10$vCd30e84HUwXyAGT0hkE9.JX9AhMgz5OIPT5IO4fQ8226vxx79WpK', 'user', '1753122121824.jpg');
...
--
ALTER TABLE `notifications`
  MODIFY `id_notification` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `rent`
--
ALTER TABLE `rent`
  MODIFY `id_rent` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
