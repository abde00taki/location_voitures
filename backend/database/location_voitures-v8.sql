...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 29 juil. 2025 à 18:12
...
(3, '2025-07-22', '2025-07-25', 2, 10, '', '2025-07-29 13:08:02'),
...
--
ALTER TABLE `notifications`
  MODIFY `id_notification` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `rent`
--
ALTER TABLE `rent`
  MODIFY `id_rent` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
